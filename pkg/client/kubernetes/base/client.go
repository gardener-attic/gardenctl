...
// GetGardenClientset will return the GardenV1Client attribute of the Client object.
func (c *Client) GetGardenClientset() *gardenclientset.Clientset {
	return c.GardenV1Client
}
...
// SetConfig will return the Config attribute of the Client object.
func (c *Client) SetConfig(config *rest.Config) {
	c.Config = config
}

// SetClientset will return the Clientset attribute of the Client object.
func (c *Client) SetClientset(clientset *kubernetes.Clientset) {
	c.Clientset = clientset
}

// SetGardenClientset will return the GardenV1Client attribute of the Client object.
func (c *Client) SetGardenClientset(client *gardenclientset.Clientset) {
	c.GardenV1Client = client
}

// SetRESTClient will return the RESTClient attribute of the Client object.

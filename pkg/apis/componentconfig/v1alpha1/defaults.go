...
func SetDefaults_GardenOperatorConfiguration(obj *GardenOperatorConfiguration) {
	...
	if len(obj.LeaderElection.LockObjectNamespace) == 0 {
		obj.LeaderElection.LockObjectNamespace = GardenOperatorDefaultLockObjectNamespace
	}
	if len(obj.LeaderElection.LockObjectName) == 0 {
		obj.LeaderElection.LockObjectName = GardenOperatorDefaultLockObjectName
	}
}
